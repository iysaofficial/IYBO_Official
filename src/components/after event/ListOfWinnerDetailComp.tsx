...
import iyboWinnerData from './iyboWinnerData.json';
...
const ListOfWinnerDetailComp: React.FC<WinnerDetailProps> = ({ year }) => {
    const data = iyboWinnerData[year as keyof typeof iyboWinnerData];
