...
const InternationalOnlineComp: React.FC = () => {
  ...
  useEffect(() => {
    const scriptURL =
      "https://script.google.com/macros/s/AKfycby3XL2bCnfEi4hD12eblum7-6db061waPFhzY6ZILUjCWC52cR1yVc0vG0Gj6Xy0o1Ujg/exec";
    ...
    <div className="page-container">
      ...
      <div className="registration-form">
        <form name="regist-form">
          ...
          <input type="hidden" name="PRICE" value="$50 USD" readOnly />
...
const HeaderSection: React.FC = () => (
  <div className="header-section">
    <div className="header-content">
      ...
      <h2 className="event-title">IYBO 2026</h2>
    </div>
  </div>
);
